      ...
      <h3 className={style.title}>Conocenos</h3>
        <div className={style.content}>
            <div className={style.icon}>
                <img src="/img/prregunta.png" alt="icono seguridad" loading="lazy"/>
            ...
            <div className={style.icon}>
                <img src="/img/pago.png" alt="icono precio" loading="lazy"/>
            ...
            <div className={style.icon}>
                <img src="/img/contacto.png" alt="icono A tiempo" loading="lazy"/>
